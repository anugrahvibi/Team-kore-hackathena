  ...
  return (
    <div ref={containerRef} className="min-h-screen w-full flex items-center justify-center p-6 relative bg-[#f8fafc] overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 space-y-8">
        ...
        <form onSubmit={handleLogin} className="glass-card p-10 rounded-[3rem] shadow-xl border-white/60 bg-white/95 backdrop-blur-3xl shadow-xl border border-white/60/70 space-y-6 premium-shadow">
          ...
          >
            Authenticate Clearance <ChevronRight size={18} className="group-hover:translate-x-1 transition-transform" />
          </button>
        ...
        <div className="flex items-center justify-center gap-4">
           ...
           <div className="flex items-center gap-2">
             ...
             <span className="text-[9px] font-black uppercase text-gray-400">E2E Encrypted Payload</span>
           </div>
           <div className="h-px w-8 bg-gray-200" />
        </div>
      </div>
